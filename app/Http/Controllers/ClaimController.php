...
class ClaimController extends Controller
{
    ...
    private function buildClaimPdfPhotoHtml($originalItem): string
    {
        ...
        $relativePath = ltrim($originalItem->foto_barang, '/');
        $absolutePath = public_path('storage/' . $relativePath);

        if (!file_exists($absolutePath) || !is_file($absolutePath)) {
            return '<span style="color:#a0aec0;font-size:12px;line-height:220px;">File foto tidak ditemukan di public storage.</span>';
        }
        ...
        return '<img src="' . $safePath . '" style="width:220px;height:auto;display:block;margin:10px auto 0;">';
    }
